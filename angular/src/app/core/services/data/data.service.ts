...
export class DataService {
  ...
  public sideBarResponsable: any = [
    {
      ...
      menu: [
        ...
        {
          menuValue: 'Categories',
          route: '/categories/category-page',
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'puzzle-piece',
          base: 'categories',
        ...
        {
          menuValue: 'Postulation',
          route: '/postulation/postulation-page',
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'share-alt',
          base: 'postulation',
  ...
  //       {
  //         menuValue: 'Articles',
  //         route: '/mag-articles/article-page',
  //         hasSubRoute: false,
  //         showSubRoute: false,
  //         icon: 'box',
  //         base: 'mag-articles',
  ...
  public getSideBarData: BehaviorSubject<Array<any>> = new BehaviorSubject<
    Array<any>
  >(this.sideBar);
  public getSideBarResponsableData: BehaviorSubject<Array<any>> =
    new BehaviorSubject<Array<any>>(this.sideBarResponsable);
  public getSideBarCondidatData: BehaviorSubject<Array<any>> = new BehaviorSubject<Array<any>>(this.sideBarCondidat);
  public getSideBarAdminData: BehaviorSubject<Array<any>> = new BehaviorSubject<
    Array<any>
  >(this.sideBarAdmin);
